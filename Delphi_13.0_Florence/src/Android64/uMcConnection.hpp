...
// (DO NOT EDIT: machine generated header) 'uMcConnection.pas' rev: 37.00 (Android)
...
public:
	...
	Umcjson::IMcJSONObject __fastcall OnRequestPost(Umcjson::IMcJSONObject AJSONObject, bool ABinary, System::Classes::TStream* ABinData);
