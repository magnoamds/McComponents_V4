...
// (DO NOT EDIT: machine generated header) 'uMcBaseSQLStrings.pas' rev: 37.00 (Android)
...
public:
	...
	/* TStringList.Create */ inline __fastcall TMcSQLStrings(System::Classes::TStringsOptions Options, System::Classes::TDuplicates Duplicates)/* overload */ : System::Classes::TStringList(Options, Duplicates) { }
