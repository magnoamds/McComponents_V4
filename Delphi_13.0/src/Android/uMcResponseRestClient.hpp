...
// (DO NOT EDIT: machine generated header) 'uMcResponseRestClient.pas' rev: 37.00 (Android)
...
namespace Umcresponserestclient
{
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_UMCRESPONSERESTCLIENT)
using namespace Umcresponserestclient;
#endif
#pragma pack(pop)
#pragma option pop
