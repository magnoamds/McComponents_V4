...
// (DO NOT EDIT: machine generated header) 'uMcRequestRestClient.pas' rev: 37.00 (Android)
...
namespace Umcrequestrestclient
{
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_UMCREQUESTRESTCLIENT)
using namespace Umcrequestrestclient;
#endif
#pragma pack(pop)
#pragma option pop
